...
<head>
    ...
    <title>@yield('title') | {{ $setting->name ?? config('app.name', 'SIMKVI!') }}</title>
    ...
    <!-- Styles -->
    {{-- @livewireStyles --}}
    <link rel="shortcut icon" href="{{ isset($setting->favicon) ? asset('storage/' . $setting->favicon) : asset('assets/images/logovokasi.png') }}" />
...
<body data-kt-name="simkvi" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true"
