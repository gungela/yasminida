            ...
            <form action="{{ route('masuk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <select name="praproduct" class="form-control @error('praproduct') is-invalid @enderror">
                                ...
                                @foreach ($praproducts as $praproduct)
                                    <option value="{{ $praproduct->praproduct }}">{{ $praproduct->praproduct }}</option>
                                @endforeach
                            </select>
                            @error('praproduct')
                                <div class="invalid-feedback">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="product"
                                class="form-control @error('product') is-invalid @enderror " placeholder="Produk " />
                            @error('product')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="total" class="form-control @error('total') is-invalid @enderror " readonly/>
                            @error('total')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
