    ...
    <div class="card card-docs flex-row-fluid mb-2">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="d-flex flex-stack">
                <a href="{{ route('keluar.print') }}" class="btn btn-secondary">
                    Cetak Data
                </a>
                <a type="button" class="btn btn-primary ms-2" href="{{ route('keluar.create') }}">
                    Tambah Data
                </a>
            </div>
        </div>
            ...
            <table id="masuk-table" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class="fw-semibold fs-6 text-muted">
                        ...
                        <th class="text-start min-w-70px">Pelanggan</th>
        ...
        $(document).on("click", ".delete-confirm", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    e.preventDefault();
                    var id = $(this).data("id");
                    var route = "{{ route('keluar.destroy', ':id') }}";
