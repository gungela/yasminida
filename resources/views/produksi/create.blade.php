                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="praproduct"
                                class="form-control @error('praproduct') is-invalid @enderror " placeholder="Produk " />
                            @error('praproduct')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateTotal() {
                ...
                const harga = parseFloat(hargaInput.value.replace(/[^0-9.-]+/g, "")) || 0; // Remove "Rp" and format
                const total = jumlah * harga;
                totalInput.value = 'Rp ' + total.toLocaleString('id-ID'); // Format total with "Rp"
            }
