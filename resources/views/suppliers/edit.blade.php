                ...
                <div class="card-body p-9">
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            value="{{ old('name') ? old('name') : $supplier->name ?? '' }}"   placeholder="Nama User " />
                            @error('name')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            value="{{ old('alamat') ? old('alamat') : $supplier->alamat ?? '' }}" class="form-control @error('alamat') is-invalid @enderror " placeholder="Alamat " />
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            value="{{ old('email') ? old('email') : $supplier->email ?? '' }}" placeholder="Email" />
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            value="{{ old('nohandphone') ? old('nohandphone') : $supplier->nohandphone ?? '' }}"   class="form-control @error('nohandphone') is-invalid @enderror " placeholder="nohandphone " />
                            @error('nohandphone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
