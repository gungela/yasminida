@extends('layouts.app')
@section('title')
    {{ Route::is('admin.*') ? 'Super Admin' : 'supplier' }}
@endsection
@section('page-title')
    ...
    <div class="card card-docs flex-row-fluid mb-2">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="d-flex flex-stack">
                <a href="{{ route('suppliers.print') }}" class="btn btn-secondary">
                    Cetak Data
                </a>
                <a type="button" class="btn btn-primary ms-2" href="{{ route('supplier.create') }}">
                    Tambah Data
                </a>
            </div>
        </div>
