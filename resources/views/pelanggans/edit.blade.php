        ...
        <div class="card-body fs-6 text-gray-700">
            ...
            <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror "
                                value="{{ old('name') ? old('name') : $pelanggan->name ?? '' }}" placeholder="Nama User " />
                            @error('name')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="alamat"
                                value="{{ old('alamat') ? old('alamat') : $pelanggan->alamat ?? '' }}"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="email" class="form-control @error('email') is-invalid @enderror "
                                value="{{ old('email') ? old('email') : $pelanggan->email ?? '' }}" placeholder="Email" />
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="text" name="nohandphone"
                                value="{{ old('nohandphone') ? old('nohandphone') : $pelanggan->nohandphone ?? '' }}"
                                class="form-control @error('nohandphone') is-invalid @enderror "
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('pelanggan.index') }}" type="reset"
